...
<jsp:include page="/WEB-INF/views/common/header.jsp">
	<jsp:param value="나의스크랩클럽" name="title"/>
</jsp:include>
	...
	<div id="menu">
		...
		<div id="menu-left">
			<select id="sortType" name="sortType" class="form-control d-inline form-select">
		      ...
		      <option ${sortType eq "oldList" ? 'selected' : ''} value="oldList">오래된순</option>
		    </select>
<%-- 		    <button 
		    	id="btn-enroll"
		    	class="btn btn-sm" 
...
<script>
	...
	document.querySelector("#sortType").addEventListener('change', (e) => {
		...
		if(selected == 'oldList'){
			location.href = `${pageContext.request.contextPath}/mypage/myScrapClubList.do?sortType=\${selected}`;
		}
		else{
			location.href = "${pageContext.request.contextPath}/mypage/myScrapClubList.do";
		}
	});
