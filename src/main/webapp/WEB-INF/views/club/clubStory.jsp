...
<section id="content">
	<div id="menuDiv">
		<ul>
			...
			<li id="second-li" class="menu-li nowPage" style="background-color: #FF9F45;"><a href="#">북클럽 스토리</a></li>
			<li id="third-li" class="menu-li" style="background-color: #FFBC80;"><a href="${pageContext.request.contextPath}/club/clubBoard.do/${club.clubNo}">게시판</a></li>
